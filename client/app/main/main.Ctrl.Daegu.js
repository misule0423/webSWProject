(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlDaegu', MainCtrlDaegu);

  MainCtrlDaegu.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlDaegu($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
