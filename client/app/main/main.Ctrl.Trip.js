(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlTrip', MainCtrlTrip);

  MainCtrlTrip.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlTrip($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
