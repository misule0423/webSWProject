(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlJeju', MainCtrlJeju);

  MainCtrlJeju.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlJeju($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
