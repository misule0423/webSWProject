(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlGwangju', MainCtrlGwangju);

  MainCtrlGwangju.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlGwangju($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
