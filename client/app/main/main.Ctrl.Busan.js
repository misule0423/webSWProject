(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlBusan', MainCtrlBusan);

  MainCtrlBusan.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlBusan($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
