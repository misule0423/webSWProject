(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlMedical', MainCtrlMedical);

  MainCtrlMedical.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlMedical($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
