(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlPerformance', MainCtrlPerformance);

  MainCtrlPerformance.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlPerformance($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
    ...
    $scope.uploadPic = function(file) {
      Upload.upload({
        ...
        data: {
          ...
          title: $scope.look.title,
          description: $scope.look.description,
          date: $scope.look.date,
          location: $scope.look.location,
          category: $scope.look.category,
