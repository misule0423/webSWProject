(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlSeoul', MainCtrlSeoul);

  MainCtrlSeoul.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlSeoul($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
