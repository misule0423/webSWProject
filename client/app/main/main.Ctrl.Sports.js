(function() {
  ...
  angular
    .module('app')
    .controller('MainCtrlSports', MainCtrlSports);

  MainCtrlSports.$inject = ['$scope', '$state', 'Auth', '$modal', 'scrapeAPI', '$http', '$alert', 'looksAPI', 'Upload'];

  function MainCtrlSports($scope, $state, Auth, $modal, scrapeAPI, $http, $alert, looksAPI, Upload) {
